...
def main():
    ...
    arg_list = [dataset_name for dataset_name in dataset_names()]
    #print(arg_list[2])
    #run_parallel(experiments_on_dataset, arg_list[4])
    experiments_on_dataset(arg_list[0])
...
def experiments_on_dataset(dataset_name):
    ...
    ensembles = [
        ...
        ("small_eole_30_Nil", make_eole(0.3, None, 100)),
